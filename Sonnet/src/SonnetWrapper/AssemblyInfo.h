...
#define VER_FILEVERSION			2,0,0,116
#define VER_FILEVERSION_STR		"2.0.0.116"
...
#if NET8_0
#ifdef WIN32
#define VER_FILEDESCRIPTION L"SonnetWrapper-latest (unstable) (net8.0, x86), based on Cbc master"
#else
#define VER_FILEDESCRIPTION L"SonnetWrapper-latest (unstable)  (net8.0, x64), based on Cbc master"
#endif
#elif NET6_0
#ifdef WIN32
